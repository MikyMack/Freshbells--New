...
import southIndianDiet from "../../../assets/images/dietplanforAge/geriatricsouth.jpg"
import northIndianDiet from "../../../assets/images/dietplanforAge/GeriatricNorth.jpg"
import aged from "../../../assets/images/dietplanforAge/aged.png"
    ...
    return (
        <div className='bg-[#EFFDEC] font-body3'>
            <div className="xl:container mx-auto px-4 pb-12">
                <Breadcrumbs title="Diet Plan For Geriatric" />
                <ToastContainer />
                <section>
                    <div className="xl:container mx-auto px-4">
                        <div className="flex flex-wrap mt-10">
                            <div className="w-full lg:w-full px-4 mb-6 lg:mb-0">
                                <h3 className="text-2xl font-semibold font-body2 mb-4"> DIET PLAN FOR GERIATRIC</h3>
                        ...
                        <div className="flex flex-wrap items-center">
                            <div className="w-full xl:w-1/2 px-4 mb-6 xl:mb-0">
                                <img loading='lazy' className="w-full h-auto object-cover" src={aged} alt="single-img-10" />
                            </div>
                ...
                <div className="xl:container px-4 mx-auto pb-20 font-body2">
                    <Heading heading="Products For Geriatric" />
