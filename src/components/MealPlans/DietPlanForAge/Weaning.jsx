...
import southIndianDiet from "../../../assets/images/dietplanforAge/Weaning_s.jpg"
import northIndianDiet from "../../../assets/images/dietplanforAge/Weaning_n.jpg"
import weaning from "../../../assets/images/dietplanforAge/weaning.png"
...
import { DietPlansForAgeWeaning } from '../../../actions/MealPlansActions'
...
export default function Weaning() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                const data = await DietPlansForAgeWeaning();
    ...
    return (
        <div className='bg-[#EFFDEC] font-body3'>
            <div className="lg:container px-4 mx-auto pb-12">
                <Breadcrumbs title="Diet Plan For Weaning" />
                <ToastContainer />
                <section>
                    <div className="xl:container mx-auto px-4">
                        <div className="flex flex-wrap mt-10">
                            <div className="w-full lg:w-full px-4 mb-6 lg:mb-0">
                                <h3 className="text-2xl font-semibold font-body2 mb-4"> DIET PLAN FOR WEANING</h3>
                        ...
                        <div className="flex flex-wrap items-center">
                            <div className="w-full xl:w-1/2 px-4 mb-6 xl:mb-0">
                                <img loading='lazy' className="w-full h-auto object-cover" src={weaning} alt="single-img-10" />
                            </div>
                            <div className="w-full xl:w-1/2 px-4 bg-white py-5">
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-lg font-body3">
