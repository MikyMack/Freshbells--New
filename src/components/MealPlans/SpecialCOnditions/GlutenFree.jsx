...
import { SpecialCategDlutenFree } from '../../../actions/MealPlansActions';
...
export default function GlutenFree() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                const data = await SpecialCategDlutenFree();
    ...
    return (
        <div className='bg-[#EFFDEC]'>
            ...
            <div className="xl:container mx-auto px-4 pb-12">
                <Breadcrumbs title="Diet Plan For Gluten Free Diet" />
                <section>
                    <div className="xl:container mx-auto px-4">
                        <div className="flex flex-wrap mt-10">
                            <div className="w-full lg:w-full px-4 mb-6 lg:mb-0">
                                <h3 className="text-2xl font-semibold font-body2 mb-4"> DIET PLAN FOR GLUTEN FREE DIET</h3>
                                <p className='font-body2 text-xl'>A gluten-free diet is a diet that excludes the protein gluten. Gluten is found in grains such as wheat, barley, rye, and their derivatives. People follow a gluten-free diet for various reasons, the most common being celiac disease, wheat allergy, and non-celiac gluten sensitivity. </p>
                                <p className='font-body2 text-xl mt-4'>When following a gluten-free diet, individuals need to be vigilant about avoiding not only obvious sources of gluten but also hidden sources. Gluten can be present in many processed foods, sauces, and even certain medications.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center">
                            ...
                            <div className="w-full xl:w-1/2 px-4 bg-white py-5">
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-lg font-body2">
                                    <li>Wheat (e.g., bread, pasta, couscous)</li>
                                    <li>Barley</li>
                                    <li>Rye</li>
                                    <li>Triticale (a cross between wheat and rye)</li>
                                </ul>
                            </div>

                        </div>
                        <div className='flex flex-col items-center justify-center mt-5'>
                            <h3 className="text-2xl font-semibold font-body2 mb-4">Gluten-free alternatives include:</h3>
                            <ul className="list-disc pl-5 space-y-2 text-lg font-body2">
                                <li>Rice</li>
                                <li>Corn</li>
                                <li>Quinoa</li>
                                ...
                                <li>Gluten-free flours (e.g., almond flour, coconut flour)</li>
                            </ul>
                        </div>
                        <p className='font-body2 text-xl mt-5'>It's important for individuals on a gluten-free diet to work closely with healthcare professionals or dietitians to ensure they maintain a balanced and nutritious diet, as eliminating gluten-containing grains may reduce the intake of certain nutrients.</p>
                ...
                <div className="xl:container px-4 mx-auto pb-20 font-body2">
                    <Heading heading="Products For Gluten-Free-Diet" />
                        ...
                        <div className="w-full lg:w-3/4  py-2">
                            {filteredProducts.length === 0 ? (
                                <div className="text-center w-full py-10">
                                    <h2 className="text-2xl font-bold text-center text-gray-600">Adding soon...</h2>
                                </div>
                            ) : (
