...
import southIndianDiet from "../../../assets/images/specialconditions/laction-s.jpg"
import northIndianDiet from "../../../assets/images/specialconditions/lactationN.jpg"
import lactating from "../../../assets/images/New folder/13.png"
...
import { SpecialCategLactatingMothers } from '../../../actions/MealPlansActions';
import { baseURL } from '../../../constants/index';
import { BsFillCartCheckFill } from "react-icons/bs";
import Loader from '../../Loader/Loader'

export default function LactatingMother() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                const data = await SpecialCategLactatingMothers();
    ...
    return (
        <div className='bg-[#EFFDEC] font-body3'>
            ...
            <div className="xl:container mx-auto px-4 pb-12">
                <Breadcrumbs title="Diet Plan For Lactating Mothers" />
                <section>
                    <div className="xl:container mx-auto px-4">
                        <div className="flex flex-wrap mt-10">
                            <div className="w-full lg:w-full px-4 mb-6 lg:mb-0">
                                <h3 className="text-2xl font-semibold font-body2 mb-4"> DIET PLAN FOR LACTATING MOTHERS</h3>
                                <p className='font-body2 text-xl'>The nutritional link between mother and baby is starting from the womb and it continues even after birth through breast milk until a period of time.So the nutritional requirement of the mother should meet her own daily needs and also enough nutrition in milk for the growing infant. In traditional indian diets were calorie rich with less nutrients and make the mother fat after the delivery.This won't make the breast milk nutritious. Here are some tips to follow during lactation which makes mother and baby healthy without making the mother fat.</p>
                            </div>
                        </div>
                        <div className="border-b my-10"></div>
                        <div className="flex flex-wrap items-center">
                            <div className="w-full xl:w-1/2 px-4 mb-6 xl:mb-0">
                                <img loading='lazy' className="w-full h-auto object-cover" src={lactating} alt="single-img-10" />
                            </div>
                            <div className="w-full xl:w-1/2 px-4 bg-white py-5">
                                <h3 className="text-2xl font-semibold font-body2 mb-4">Diet tips on lactation</h3>
                                <ul className="list-disc pl-5 space-y-2 text-lg font-body2">
                                    <li>Should consume 2-3 litres of fluid in the form of water  or juices </li>
                                    ...
                                    <li>High omega 3 fat such as nuts seeds and dairy products will increase the milk production</li>
                                    <li>Increasing intake of protein in your diet will increase the quality of breast milk.</li>
                                </ul>
                            </div>
                        ...
                        <div className='flex flex-col items-center justify-center mt-5'>
                            ...
                            <ul className="list-disc pl-5 space-y-2 text-lg font-body2">
                                ...
                                <li>Caffeine absorbed in human milk and it will decrease the milk production</li>
                                ...
                                <li>Maintain a 4hr gap between each meal and don't exceed 4hrs.</li>
                                <li>Have your last meal 2 hours before going to bed.</li>
                                <li>Quality sleep</li>
                            </ul>
                        </div>
                        <p className='text-red-400 font-body2 xs:text-sm md:text-xl mt-5'>Remember and Please note:This is a sample menu for lactating mother.Individual needs will vary based on age, sex, height, weight, activity level, and any chronic health conditions or diseases. Consult your physician or health care provider before starting any diet plan.</p>
                        <div className="border-b my-10"></div>
                    </div>
                </section>
                <div className="xl:container px-4 mx-auto pb-20 font-body2">
                    <Heading heading="Products For Lactating Mothers" />
