                    ...
                    <div className="xl:container mx-auto px-4">
                        <div className="flex flex-wrap mt-10">
                            <div className="w-full lg:w-full px-4 mb-6 lg:mb-0">
                                ...
                                <p className='font-body2 text-xl'>Proper nutrition during pregnancy is crucial for the health of both the mother and the developing baby. A balanced diet helps ensure that the baby grows and develops properly while keeping the mother healthy and energised.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center">
                            ...
                            <div className="w-full xl:w-1/2 px-4 bg-white py-5">
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-lg font-body2">
                                    <li>Balanced Meals: Focus on a variety of foods to ensure a range of nutrients. Include a mix of fruits, vegetables, whole grains, proteins, and healthy fats.</li>
                                    <li>Hydration: Drink plenty of water to stay hydrated and support increased blood volume.</li>
                                    <li>Frequent, Small Meals: Eating smaller, more frequent meals can help manage nausea and ensure steady nutrient intake.</li>
                                    <li>Avoid Harmful Substances: Limit caffeine intake. Avoid alcohol, smoking, and unpasteurized foods. Be cautious with certain fish due to mercury content (e.g., shark, swordfish).</li>
                                    <li>Supplements: Prenatal vitamins can help fill any nutritional gaps but should complement a healthy diet, not replace it.</li>
                                    <li>Safe Food Practices: Ensure food is properly cooked to avoid foodborne illnesses. Wash fruits and vegetables thoroughly.</li>
                                </ul>
                            </div>
